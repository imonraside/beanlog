...
export const PWASetup = () => {
    ...
    useEffect(() => {
        ...
        const handler = (e) => { 
            // e.preventDefault(); // 주소창의 기본 설치 아이콘이 나타나도록 주석 처리
            setDeferredPrompt(e); 
    ...
    const handleInstall = () => { if (!deferredPrompt) return; deferredPrompt.prompt(); deferredPrompt.userChoice.then((res) => { if (res.outcome === 'accepted') { setShowInstallBtn(false); setDeferredPrompt(null); window.deferredPrompt = null; } }); };
